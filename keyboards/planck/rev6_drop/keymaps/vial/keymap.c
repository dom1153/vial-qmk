...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER2] = LAYOUT(KC_TRNS, KC_TAB, KC_TAB, KC_TAB, KC_TAB, KC_TAB, KC_TAB, KC_P7, KC_P8, KC_P9, KC_P0, KC_TRNS, KC_TRNS, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NO, KC_NO, KC_P4, KC_P5, KC_P6, KC_NO, KC_DEL, KC_TRNS, KC_GRV, KC_GRV, KC_GRV, KC_GRV, KC_GRV, KC_GRV, KC_P1, KC_P2, KC_P3, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),

    [_LAYER3] = LAYOUT(KC_TRNS, KC_GRV, KC_TILD, KC_LBRC, KC_RBRC, KC_BSLS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_UNDS, KC_MINS, KC_PLUS, KC_EQL, KC_PIPE, KC_NO, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_DEL, KC_TRNS, KC_LT, KC_GT, KC_LPRN, KC_RPRN, KC_SLSH, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
